package com.example.gavitexpress.utilities;

public class Constants {
    //public static String API_BASE_URL = "http://gavitexpress.com/";
    //public static String API_BASE_URL = "https://tutorials.mianasad.com/ecommerce/";
    public static String API_BASE_URL = "http://192.168.35.77/ecom/";
