...
import com.example.gavitexpress.adapters.CartAdapter;
import com.example.gavitexpress.databinding.ActivityChackoutBinding;
...
public class ChackoutActivity extends AppCompatActivity {
    ...
    ActivityChackoutBinding binding;
    CartAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityChackoutBinding.inflate(getLayoutInflater());
            ...
            public void onResponse(JSONObject response) {
                try {
                    if (response.getString("status").equals("success")) {
                        Toast.makeText(ChackoutActivity.this, "Success order.", Toast.LENGTH_SHORT).show();
                        String orderNumber = response.getJSONObject("data").getString("code");
                        new AlertDialog.Builder(ChackoutActivity.this)
                                ...
                                .setPositiveButton("Pay Now", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        Intent intent = new Intent(ChackoutActivity.this, PaymentActivity.class);
                        ...
                        Toast.makeText(ChackoutActivity.this, "Failed order.", Toast.LENGTH_SHORT).show();
                    }
